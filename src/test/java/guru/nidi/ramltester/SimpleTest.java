...
public class SimpleTest extends HighlevelTestBase {
	...
	public void failFastTest() throws Exception {
		try {
			...
			assertEquals(
					"RamlReport{requestViolations=[Request URL http://localhost/base/path/noexisting does not match base URI http://nidi.guru/raml/{version}], responseViolations=[], validationViolations=[]}",
					e.getMessage());
