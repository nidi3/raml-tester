...
public class ContentNegotiationTest extends HighlevelTestBase {
    ...
    public void wildcardAcceptHeaderIsOk() throws Exception {
        assertThat(test(simple, get("/mediaType").accept("*/*"), response(201, "", "text/xml;bla=blu")), hasNoViolations());
    }

    @Test
    public void responseMayHaveParametersThatAreNotInRamlNeitherInAccept() throws Exception {
        assertThat(test(simple, get("/mediaType").accept("text/xml"), response(201, "", "text/xml;bla=blu")), hasNoViolations());
    }

    @Test
    public void noResponseContentTypeIsOk() throws Exception {
        assertThat(test(simple, get("/mediaType").accept("bla/blu"), response(201, "", null)), hasNoViolations());
    }
    ...
    public void useQValue() throws Exception {
        assertThat(test(simple, get("/mediaType").accept("text/plain;q=.5", "text/xml"), response(201, "", "text/xml")), hasNoViolations());
        assertOneResponseViolationThat(
